...
namespace SprayDay
{
	public static class Primitives2D
	{
		...
		public static void LoadPixel(Texture2D t)
		{
			pixel = t;
		}
		...
		private static void CreatCustomPixel(Texture2D texture)
		{
			pixel = texture;
		}
		...
		public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point, float length, float angle, Color color, float thickness)
		{
			...
			spriteBatch.Draw(pixel,
			                 ...
			                 //new Vector2(pixel.Width/8, pixel.Height/8),
			                 new Vector2(length, 2), //Проблема в переменной lenght
			                 SpriteEffects.None,
			                 0);
		}
		...
		public static void PutPixel(this SpriteBatch spriteBatch, Vector2 position, Texture2D texture, Color color)
		{
			if (pixel == null)
			{
				CreatCustomPixel (texture);
			}

			spriteBatch.Draw (pixel, position, color);
		}

		public static void PutPixel(this SpriteBatch spriteBatch, float x, float y, Texture2D texture, Color color)
		{
			if (pixel == null)
			{
				CreatCustomPixel (texture);
